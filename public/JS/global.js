...
let asteroid_spawnInterval = 100;
let next_toSpawn = 0;
...
class Background_ {
    ...
    constructor(){
        //add background image to the game and keep it moving
        this.img = new Image();
        this.img.src = "../IMG/backgrounds/background-1.jpg";
        this.width = 8188;
    ...
    update(){
        ...
        if(this.x + this.width < 0){
            ...
            this.x = 0;
            this.img.src = background_array[this.nextBackground];
            this.nextBackground++;
            if(this.nextBackground > background_array.length - 1){
                this.nextBackground = 0;
            }
